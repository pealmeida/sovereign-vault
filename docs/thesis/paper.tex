...
Resultado adversarial & 10/10 sondas e 2/2 controles, sem falhas de transporte & execução preliminar de uma sessão; valida transporte WS, escopo, caminho e política simulada, sem controlador desktop real, atacante adaptativo ou inferência de taxa populacional \\
\bottomrule
\end{tabularx}
